...
type LocalCategory = { id: string; name: string; description?: string };

const Filter = ({ categories }: { categories: LocalCategory[] }) => {
    ...
    const filterData: (LocalCategory | { id: string; name: string })[] = categories
