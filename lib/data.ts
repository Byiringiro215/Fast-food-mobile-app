const dummyData = {
    categories: [
        { id: 'category-1', name: "Burgers", description: "Juicy grilled burgers" },
        { id: 'category-2', name: "Pizzas", description: "Oven-baked cheesy pizzas" },
        { id: 'category-3', name: "Burritos", description: "Rolled Mexican delights" },
        { id: 'category-4', name: "Sandwiches", description: "Stacked and stuffed sandwiches" },
        { id: 'category-5', name: "Wraps", description: "Rolled up wraps packed with flavor" },
        { id: 'category-6', name: "Bowls", description: "Balanced rice and protein bowls" },
    ],
